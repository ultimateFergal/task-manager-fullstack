...
/** Componente cliente del gestor de tareas — lista, formulario y estadísticas */
        ...
        <div className='bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 md:p-8'>
          ...
          <div className='flex items-start justify-between mb-8'>
            ...
            <button
              ...
              className='text-sm text-gray-500 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400 transition-colors mt-1'
            >
              Cerrar sesión
            </button>
          </div>
